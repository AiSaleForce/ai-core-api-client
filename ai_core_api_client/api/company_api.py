...
class CompanyApi:
    ...
    def company_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[DomainCompany]]:
        """Returns a list of companies
    ...
    def company_id_delete(
        self,
        id: Annotated[StrictStr, Field(description="Company ID")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def company_id_delete_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DomainSuccessResponse]:
        """Delete company from the database
    ...
    def company_patch(
        self,
        request: Annotated[DomainCompanyUpdateRequest, Field(description="Company Update Request")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param request: Company Update Request (required)
        :type request: DomainCompanyUpdateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._company_patch_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def company_patch_with_http_info(
        self,
        request: Annotated[DomainCompanyUpdateRequest, Field(description="Company Update Request")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def company_patch_without_preload_content(
        self,
        request: Annotated[DomainCompanyUpdateRequest, Field(description="Company Update Request")],
        _request_timeout: Union[
            None,
    ...
    def company_post(
        self,
        request: Annotated[DomainCompanyCreateRequest, Field(description="Company Create Request")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param request: Company Create Request (required)
        :type request: DomainCompanyCreateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
